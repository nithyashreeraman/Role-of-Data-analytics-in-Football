...
# Load your dataset
df = pd.read_excel('C:/Users/91940/Desktop/College/College/VIT/College/Year/8th Sem/Capstone/Code/Optimal Formation/Dataset/Ger/Matches 21-22.xlsx')
...
def get_formation():
    ...
    # Get unique team names
    teams = df['Team'].unique()
    return render_template('formation.html', team=team, plot_data=plot_data, teams=teams, best_formation=best_formation, key=key)
